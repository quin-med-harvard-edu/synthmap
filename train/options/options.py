...
class BaseArgs():
    ...
    def __init__(self,fromnotebook=False):
        ...
        self.parser.add_argument('--mask_threshold', type=int, default=100, help='value to make all images with (during normalization)')        
        ...
        # shape 
        #self.parser.add_argument('--shape', type=int, , default = [192,192], help='choose which data to train with')       
